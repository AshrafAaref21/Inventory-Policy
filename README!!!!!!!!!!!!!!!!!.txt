It's a Model to take Purchasing decision for about 50 SKUs according to our business parameters and, Economy and Market uncertainties... 

Starting with Cleanings and Treating the Sales data '19 Months' and making analysis to allocate the expected mean of sales and its variance to allocate its a strategic SKU or not to get the minimum safety stock for each SKU according at some CSL (95% for strategic SKUs,.. down to 65% to not important SKUs)

Then I Calculated the Order Quantity according to its company limitations and our demand fulfillment.
